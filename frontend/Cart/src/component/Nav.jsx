  ...
  return (
    <div className='w-[100vw] h-[70px] bg-[#ecfafaec] z-10 fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black '>
      ...
      <div className='w-[20%] lg:w-[30%] flex items-center justify-start gap-[10px]'>
        ...
        <h1 className='text-[25px] text-[black] font-sans'>Vcart</h1>
      </div>

      {/* Menu */}
      <div className='w-[50%] lg:w-[40%] justify-center hidden md:flex'>
      ...
      <div className='w-[30%] flex items-center justify-end gap-[20px]'>
        ...
        <p className='absolute w-[18px] h-[18px] items-center md:flex justify-center bg-black px-[5px] py-[2px] text-white rounded-full text-[9px] top-[10px] right-[23px] hidden hidden md:block'>{getCartCount()}</p>
      </div>
      ...
      <div className='w-[100vw] h-[90px] flex items-center justify-between px-[20px] text-[12px] fixed bottom-0 left-0 bg-[#191818] md:hidden'>
        ...
        <button className='text-[white] flex items-center justify-center flex-col gap-[2px]'onClick={()=>navigate("/collection")}><MdCollections className='w-[28px] h-[28px] text-[white] md:hidden'/>Collection</button>
