  ...
  return (
    <div className='fixed lg:bottom-[20px] md:bottom--[40px] bottom-[80px] left-[2%]'onClick={()=>{recognition.start();
      ...
      <img 
        src={ai} 
        alt="ai" 
        className={`w-[100px] h-[100px] rounded-full border-4 border-white cursor-pointer object-cover ${activeAi ? 'translate-x-[10%] translate-y-[10%] scale-125' : 'translate-x-[0] translate-y-[0] scale-100'} transition-transform`} style={{
