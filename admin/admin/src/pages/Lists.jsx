  ...
  return (
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white]'>
      ...
      <div className='w-[100%] h-[100%] flex'>
        <Sidebar/>
        <div className='flex-1 mt-[70px] flex flex-col items-center justify-start gap-[30px] overflow-x-hidden py-[50px]'>
          <div className='text-center text-[25px] md:text-[40px] font-semibold'>
            All Listed Products
          </div>

          {
            list?.length > 0 ? (
                list.map((item,index)=>(
                    <div className='w-[50%] md:h-[120px] h-[90px] bg-slate-600 rounded-xl flex items-center justify-start gap-[5px] md:gap-[30px] p-[10px] md:px-[30px]' key={index}>
                        <img src={item.image1} className='w-[30%] md:w-[120px] h-[90%] rounded-lg' alt="" />
                        <div className='w-[60%] h-[80%] flex flex-col items-start justify-center gap-[2px]'>
